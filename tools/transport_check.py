...
Every per-API decision the add-on makes goes through the port in src/neural/transport.h; a
...
FACTORY = ROOT / "src/neural/transports.inc"
SCOPE = [ROOT / "src/neural", ROOT / "src/framecheck", ROOT / "src/x86bridge/host64.cpp"]
